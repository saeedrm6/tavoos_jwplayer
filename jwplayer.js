...
window.jwplayer = function (s) {
    ...
    t.b = function (a) {
        ...
        this.edition = function () {
            return window.location.hostname.includes("namasha.com") ? "unlimited" : d
        }, this.token = function () {
            return t
    ...
    var ae = ee(0), r = ee(55), ne = ee(44), o = ee(20), i = ee(12), a = ee(5), c = ee(40), s = ee(14), u = {
        ...
        if ("free" === a.edition() && (v = Object(ae.k)({
            skin: {active: "#ff0046", controlbar:{iconsActive:"#f00",icons:"#fff"}, timeslider:{progress:"#f00"},menus:{textActive:"#f00"}},
